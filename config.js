...
const STATIC_REF_CONTAINER_DATA_PATH = process.env.STATIC_REF_CONTAINER_DATA_PATH || '/tmp/reference';
...
const STATIC_SOL_CONTAINER_DATA_PATH = process.env.STATIC_SOL_CONTAINER_DATA_PATH || '/tmp/solution';
